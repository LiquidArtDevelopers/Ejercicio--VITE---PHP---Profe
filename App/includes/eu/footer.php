<footer class="footer01">
  <div class="footer01__inner">
    <section class="footer01__column" aria-labelledby="footer01-menu-title">
      <h2 class="footer01__title" id="footer01-menu-title">Nabigazioa</h2>
      <?php $enlacesId = 'footer-productos-eu'; ?>
      <?php require app_path('includes/eu/enlaces.php'); ?>
    </section>

    <section class="footer01__column" aria-labelledby="footer01-legal-title">
      <h2 class="footer01__title" id="footer01-legal-title">Legezkoa</h2>
      <ul class="footer01__list">
        <li><a class="footer01__link" href="<?= e(route_url('/lege-oharra')) ?>#aviso-legal">Lege oharra</a></li>
        <li><a class="footer01__link" href="<?= e(route_url('/lege-oharra')) ?>#politica-privacidad">Pribatutasun politika</a></li>
        <li><a class="footer01__link" href="<?= e(route_url('/lege-oharra')) ?>#gestion-cookies">Cookieen kudeaketa</a></li>
      </ul>
    </section>

    <section class="footer01__column" aria-labelledby="footer01-contact-title">
      <h2 class="footer01__title" id="footer01-contact-title">Kontaktua</h2>
