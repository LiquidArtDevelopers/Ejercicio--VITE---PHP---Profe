...
<body>
    ...
    <header class="header02">
        ...
        <h1 class="header02__title">Contacta con tu pintor y restaurador de muebles</h1>
    ...
    <main>
        ...
        <section>
            <!-- SECCIÓN PRESENTACIÓN CONTACTO -->
            <!-- Artículo 03 -->
            <article class="art03">                
                
                <div class="h2Especial">
                    <span></span>
                    <h2>Te atenderemos en menos de 24h</h2>
                </div>
        ...
        <section>
            <!-- SECCIÓN DE VALORES Y FAQ -->
            <div class="h2Especial">
                <span></span>
                <h2>Valores y preguntas frecuentes</h2>
            </div>

            <!-- artículo 09 -->
             <!-- NUESTROS VALORES Y DIFERENCIAS -->
            <article class="art09">
            ...
            <article class="artAcordeon01">
                <div class="cabecera">
                    <div>
                        <h3>Lo que los clientes nos preguntan</h3>
        ...
        <section>
            <!-- SECCIÓN FORM Y DATOS DE CONTACTO -->
            <!-- artForm02 ajax -->
